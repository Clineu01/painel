...
```
bash <(wget -qO- https://github.com/Clineu01/painel/main/painelwv5/ubuinst.sh)
```
...
```
apt install wget -y; bash <(wget -qO- https://github.com/Clineu01/painel/main/painelwv5/sincpainel.sh)
```
